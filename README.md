...
- **Player** — a schermo intero, GIF di sfondo, controlli play/pausa/avanti/indietro, annunci vocali (Web Speech API del browser o ElevenLabs, vedi sotto). Countdown per esercizi/serie; il **riposo tra blocchi è un cronometro che conta in su** (nessun tempo imposto: l'atleta preme avanti quando è pronto, vedendo quanto tempo è passato) e mostra un'anteprima del blocco in arrivo (solo Circuiti). Il livello di carico da usare (per esercizi con attrezzo, corpo libero escluso) lo **prescrivi tu** in fase di creazione — l'atleta lo vede a schermo insieme a nome esercizio e ripetizioni, non gli viene chiesto. Le serie Max/AMRAP non chiedono più quante ripetizioni sono state fatte (tolto: era un'interruzione non voluta su ogni esercizio Max) — l'unica cosa ancora annotata dall'atleta durante l'esecuzione è il peso davvero usato, a fine di ogni blocco Circuito con attrezzi (vedi sotto).
